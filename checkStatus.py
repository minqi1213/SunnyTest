...
#    custom_content = json.loads('{"action_type":5,"url":"silent.m4a"}')
#    device_token = 'AkoIFaVjsTIqI2nrIzSbyMa6EpYEFSNFxwcizV1bQhEH,AhFtEA2Dxekaq-v4GwpzreHgWtNYrokgk3UPpbcnTE9W'

#    task_id = push_broadcast(appkey, app_master_secret, device_token, custom_content)
#    print task_id
    print check_status(appkey, sys.argv[1])
