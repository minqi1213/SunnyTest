...
if __name__ == '__main__':
    ...
    # 配置如下变量
    hostaddr = '101.200.179.166' # ftp地址
    username = 'sunnytest' # 用户名
    password = 'Beijing123' # 密码
    port  =  21   # 端口号 
    rootdir_local  = './' # 本地目录
    rootdir_remote = '/var/ftp/pub/BaiduMap/H60-L01'          # 远程目录
    
    f = MYFTP(hostaddr, username, password, rootdir_remote, port)
    f.login()
    #f.download_files(rootdir_local, rootdir_remote)
    f.download_file("./cpumeminfo.log", "/var/ftp/pub/BaiduMap/H60-L01/cpumeminfo.log")
